			...
			<div class="toolbar py-5 pb-lg-15" id="kt_toolbar">
				...
				<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
					...
					<div class="page-title d-flex flex-column me-3">
						<!--begin::Title-->
						<h1 class="d-flex text-white fw-bold my-1 fs-3">Struktur Orgnaisasi</h1>
						<!--end::Title-->
						<!--begin::Breadcrumb-->
						<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
							...
							<!--end::Item-->
							<!--begin::Item-->
							<li class="breadcrumb-item text-white opacity-75">Struktur Organisasi</li>
							<!--end::Item-->
						</ul>
						<!--end::Breadcrumb-->
					</div>
				...
				<div class="pt-20" style="background: linear-gradient(to top, #6E7049 25%, #87908F 75%);">
					...
					<div class="container">
						<div class="text-center mb-17">
							...
							<!--end::Title-->
							<!--begin::Description-->
							<div class="fs-5 text-white fw-bold" style="text-align: justify; padding-left: 10%; padding-right: 10%">Unit Kerja Teknologi Informasi DPN merupakan salah satu kelompok kerja Dewan Pertahanan Nasional yang bertugas memberikan dukungan  teknologi dan informasi dalam menjalankan tugas pemberian
