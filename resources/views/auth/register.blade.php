                    ...
                    <div class="w-lg-500px p-10">
                        ...
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="fv-row mb-8">
                                <!--begin::Nama-->
                                <x-input id="name" class="form-control bg-transparent" placeholder="Name" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
                                <!--end::Nama-->
                            </div>
                            <!--begin::Input group=-->
                            <div class="fv-row mb-8">
                            ...
                            <div class="fv-row mb-8" data-kt-password-meter="true">
                                <div class="mb-1">
                                    <div class="position-relative mb-3">
                                        <x-input id="password" class="form-control bg-transparent" placeholder="Password" type="password" name="password" required autocomplete="new-password" />
                            ...
                            <div class="fv-row mb-8">
                                <x-input id="password_confirmation" class="form-control bg-transparent" placeholder="Confirm Password" type="password" name="password_confirmation" required autocomplete="new-password" />
                            </div>
                            <!--end::Input group=-->
                            <!--begin::Accept-->
                            <div class="fv-row mb-8">
                                <label class="form-check form-check-inline">
                                    ...
                                    <span class="form-check-label fw-semibold text-gray-700 fs-base ms-1">
                                        ...
                                        'terms_of_service' => '<a class="text-primary" data-bs-toggle="popover" data-bs-custom-class="popover-inverse" data-bs-placement="top" title="Terms of Service" data-bs-content="Terms of Service">Terms of Service</a>',
                                        'privacy_policy' => '<a class="text-primary" data-bs-toggle="popover" data-bs-custom-class="popover-inverse" data-bs-placement="top" title="Privacy Policy" data-bs-content="Privacy Policy">Privacy Policy</a>',
                                        ]) !!}
                                    </span>
                            ...
                            <div class="d-grid mb-10">
                                <x-button type="submit" id="kt_sign_up_submit" class="btn btn-primary">
