					...
					<div style="position: absolute;top: 0;left: 0;width: 100%;height: 100%;background: linear-gradient(to top, #894C2C 25%, transparent 40%);opacity: 0.65;pointer-events: none;z-index: 1; "></div>
						...
						<div class="landing-header" data-kt-sticky="true" data-kt-sticky-name="landing-header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
							...
							<nav class="d-flex align-items-center align-items-center position-relative" style="background: linear-gradient(to right, #F5E4CA 15%, #6E7049 50%, #292D31 85%); z-index: 50; height: 75px;">								
								...
								<div class="d-flex align-items-center">
									<a href="#" class="nav-link me-20" style="font-size: medium; color: #5C0000;">Profil</a>
								</div>
						...
						<div class="d-flex flex-column flex-end w-100 min-h-350px min-h-lg-500px px-9">
							...
							<div class="container position-relative" style="z-index: 20">
								<div class="mb-5 mb-lg-10" style="padding-left: 10%; padding-right: 10%; text-align:justify!important;">
									<!--begin::Title-->
									<p class="text-white lh-base" style="font-size: 18px;">DPN (Dewan Pertahanan Nasional) merupakan Lembaga Non Struktural yang bertugas memberikan pertimbangan dan perumusan solusi kebijakan di bidang pertahanan nasional yang mencakup kedaulatan negara, keutuhan wilayah, dan keselamatan bangsa (IPOLEKSOSBUDHANKAM).</p>
									<!--end::Title-->
									<!--begin::Action-->
									<!--end::Action-->
								</div>
					...
					<div class="container">
						...
						<div class="d-flex flex-center">
							...
							<div class="d-flex flex-wrap flex-center justify-content-lg-between mb-15 mx-auto w-xl-900px">
								<!--begin::Item-->
								<div class="d-flex flex-column flex-center h-200px w-200px h-lg-250px w-lg-250px m-3 bgi-no-repeat bgi-position-center bgi-size-contain" style="background-image: url('resources/media/svg/misc/octagon.svg')">
									<!--begin::Symbol-->
				...
				<div class="container">
					...
					<div class="tns tns-default" style="direction: ltr">
						...
						<div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false" data-tns-speed="2000" data-tns-autoplay="true" data-tns-autoplay-timeout="18000" data-tns-controls="true" data-tns-nav="false" data-tns-items="1" data-tns-center="false" data-tns-dots="false" data-tns-prev-button="#kt_team_slider_prev" data-tns-next-button="#kt_team_slider_next" data-tns-responsive="{1200: {items: 3}, 992: {items: 2}}">
							...
							<div class="text-center">
								<!--begin::Photo-->
								<div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('resources/media/avatars/300-1.jpg')"></div>
								<!--end::Photo-->
								<!--begin::Person-->
								<div class="mb-0">
									<!--begin::Name-->
							...
							<div class="text-center">
								<!--begin::Photo-->
								<div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('resources/media/avatars/300-2.jpg')"></div>
								<!--end::Photo-->
								<!--begin::Person-->
								<div class="mb-0">
									<!--begin::Name-->
							...
							<div class="text-center">
								<!--begin::Photo-->
								<div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('resources/media/avatars/300-5.jpg')"></div>
								<!--end::Photo-->
								<!--begin::Person-->
								<div class="mb-0">
									<!--begin::Name-->
							...
							<div class="text-center">
								<!--begin::Photo-->
								<div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('resources/media/avatars/300-20.jpg')"></div>
								<!--end::Photo-->
								<!--begin::Person-->
								<div class="mb-0">
									<!--begin::Name-->
							...
							<div class="text-center">
								<!--begin::Photo-->
								<div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('resources/media/avatars/300-23.jpg')"></div>
								<!--end::Photo-->
								<!--begin::Person-->
								<div class="mb-0">
									<!--begin::Name-->
							...
							<div class="text-center">
								<!--begin::Photo-->
								<div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('resources/media/avatars/300-12.jpg')"></div>
								<!--end::Photo-->
								<!--begin::Person-->
								<div class="mb-0">
									<!--begin::Name-->
							...
							<div class="text-center">
								<!--begin::Photo-->
								<div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('resources/media/avatars/300-9.jpg')"></div>
								<!--end::Photo-->
								<!--begin::Person-->
								<div class="mb-0">
									<!--begin::Name-->
							...
							<div class="d-flex flex-column justify-content-between h-lg-100 px-10 px-lg-0 pe-lg-10 mb-15 mb-lg-0">
								...
								<div class="d-flex align-items-center">
									...
									<div class="symbol symbol-circle symbol-50px me-5">
										<img src="resources/media/avatars/300-1.jpg" class="" alt="" />
									</div>
									<!--end::Avatar-->
									<!--begin::Name-->
						...
						<div class="col-lg-4">
							...
							<div class="d-flex flex-column justify-content-between h-lg-100 px-10 px-lg-0 pe-lg-10 mb-15 mb-lg-0">
								...
								<div class="d-flex align-items-center">
									<!--begin::Avatar-->
									<div class="symbol symbol-circle symbol-50px me-5">
										<img src="resources/media/avatars/300-2.jpg" class="" alt="" />
									</div>
									<!--end::Avatar-->
									<!--begin::Name-->
									<div class="flex-grow-1">
						...
						<div class="col-lg-4">
							...
							<div class="d-flex flex-column justify-content-between h-lg-100 px-10 px-lg-0 pe-lg-10 mb-15 mb-lg-0">
								...
								<div class="d-flex align-items-center">
									<!--begin::Avatar-->
									<div class="symbol symbol-circle symbol-50px me-5">
										<img src="resources/media/avatars/300-16.jpg" class="" alt="" />
									</div>
									<!--end::Avatar-->
									<!--begin::Name-->
									<div class="flex-grow-1">
